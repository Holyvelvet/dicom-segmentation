...
# dicom_segmentation documentation build
...
from dicom_segmentation import __version__ as release

# -- Project information -----------------------------------------------------

project = "dicom_segmentation"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "dicom_segmentationdoc"
...
latex_documents = [
    (
        master_doc,
        "dicom_segmentation.tex",
        "dicom_segmentation Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "dicom_segmentation",
        "Project dicom_segmentation codebase.",
        "Data-Science",
    )
]
